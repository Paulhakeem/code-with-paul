...
<section
  ...
  <div
    ...
    <div class="flex justify-center">
      <a href="#!" class="mr-6 text-blue-800 dark:text-neutral-200">
        <svg
      ...
      <a href="#!" class="mr-6 text-blue-800  dark:text-white">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
          fill="currentColor"
      ...
      <a href="#!" class="text-blue-800  dark:text-white">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
          fill="currentColor"
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      <div class="">
        <h6
          class="mb-4 flex items-center text-blue-800 justify-center font-semibold uppercase md:justify-start tracking-wide">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
      ...
      <div class="">
        <h6
          class="mb-4 flex justify-center font-semibold uppercase md:justify-start text-blue-800 tracking-wide">
          Our Services
        </h6>
        <p class="mb-4">
